...
window.renderResume = function() {
    return `
        <div class="section active">
            ...
            <div class="card">
                <h3>💡 О себе</h3>
                <p>PHP-разработчик с 4+ годами опыта. Специализируюсь на бэкенд-разработке, проектировании API, оптимизации производительности и архитектуре. Работал с Laravel, Symfony, микросервисами и высоконагруженными проектами. Стремлюсь к позиции Senior/Team Lead.</p>
            </div>
            ...
            <div class="card-grid">
                ...
                <div class="card">
                    ...
                    <p>PHP: 8/10<br>Laravel: 8/10<br>Symfony: 6/10<br>MySQL: 7/10<br>Docker: 7/10<br>Архитектура: 6/10</p>
                </div>
            </div>
